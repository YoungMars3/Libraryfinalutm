...
class BookStore:
    ...
    def show_cover_image(self, title):
        img_path = f'C:\\Users\Omerw\Desktop\libraryfinal\book_cover\\{title.lower().replace(" ", "_")}.jpg'
        try:
...
while True:
    ...
    # Choosing options
    while True:
        action = input("\nChoose an action (1-Browse | 2-Search | 3-Add to cart | 4-View cart | 5-Check Out | 6-Leave):  ")
